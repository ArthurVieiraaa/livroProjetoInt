        ...
        <div class="main-registro">
            <div class="card-registro">
                ...
                <div class="textofield">
                    ...
                    <input type="text" name="cpf" required id='cpf' placeholder="000.000.000-00" autocomplete="off"
                        maxlength="14" value="<?php echo $cpf ?>">
                    <span id='span-error-cpf' style='color: #00c3ff;'>*
                        <?php echo $cpfErr ?>
                    </span>
                </div>
                <div class="textofield">
                    <label for="telefone">Telefone</label>
                    <input type="text" name="phone" required id="phone" placeholder="(00) 0 0000-0000"
                        autocomplete="off" maxlength="15" value="<?php echo $telefone ?>">
                    <span id='span-error-phone' style='color: #00c3ff;'>*
                        <?php echo $telefoneErr ?>
                    </span>
                </div>
                <div class="textofield">
                ...
                <div class="textofield">
                    ...
                    <input type="password" name="senhaconf" placeholder="Confirme sua Senha"
                        value="<?php echo $senhaconf ?>">
                    <span class="obrigatorio">*
                        <?php echo $senhaconfErr ?>
                    </span>
                </div>
