...
<h1 class="titulo-txt">Alterações do usuario</h1>
    <fieldset class="card-cad">
        <div>
            <label class="cod_livro" for="cod_livro"><p> cod_livro: <?php echo $cod_livro?> </p></label>
            <br>
        </div>

        <div class="textfield">
            <label for="titulo"><p class="txt-alt"> Titulo: </p></label>
            <input class="input-login" type="text" name="text" value="<?php echo $titulo?>">
            <span class="obrigatorio">*
        </div>
        
        <div class="textfield">
            <label for="Ano"><p class="txt-alt"> Ano: </p></label>
            <input class="input-login" type="text" name="Ano" value="<?php echo $Ano?>">
         <span class="obrigatorio">*
        </div>
        
        <div class="textfield">
            <label for="Autor"><p class="txt-alt"> Autor: </p></label>
